...
<Meta of={ModalStories} title="Documentation/Base UI/Modal" />
...
Custom z-index for stacking multiple modals:
...
// Third modal (on top of second)
<Modal zIndex={1020}>
  Third modal content
</Modal>
```

This prop is particularly useful when you need to display multiple modals at once, ensuring proper stacking order. Each modal should have a higher z-index than the one below it.
